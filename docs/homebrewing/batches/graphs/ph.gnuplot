...
plot "ph_09-16.data" using 1:2:3 with linespoints lc variable notitle, \
    keyentry with point lc  9 lt 1 title "Batch #9", \
    keyentry with point lc 10 lt 1 title "Batch #10", \
    keyentry with point lc 11 lt 1 title "Batch #11", \
...
set autoscale x
# plot the graph
plot "ph_25-32.data" using 1:2:3 with linespoints lc variable notitle, \
    ...
    keyentry with point lc 30 lt 1 title "Batch #30", \
    keyentry with point lc 31 lt 1 title "Batch #31", \
    keyentry with point lc 32 lt 1 title "Batch #32"
# set output back to default
set output
# reset terminal type
set terminal pop
